...
DuploJS est un framework TypeScript (Type-safe) back-end orienté fonctionnel simple d'utilisation qui pourrait même être utilisé par des développeurs front-end ;).
